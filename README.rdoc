...
7. Configure your own server, recommended using Passenger (https://www.phusionpassenger.com/)
8. If you only need the Matlab scripts, it is located in tasks/rwrh/
